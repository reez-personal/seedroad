...
impl Renderer {
    ...
    pub fn render(
        ...
        // Scene renders into screen_view; post-process reads it and writes to swapchain.
        ...
        // Reads scene_target (which now has the fully composited scene) and
        // writes to the swapchain with lens-water overlay.
        {
